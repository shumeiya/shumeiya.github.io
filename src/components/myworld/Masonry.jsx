...
// A lightweight masonry photo wall (CSS columns + break-inside-avoid) — same visual
// as reactbits' Masonry, but with no extra deps. Natural image ratios stagger the rows.
